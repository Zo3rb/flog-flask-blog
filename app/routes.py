...
from app.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, ResetRequestForm, ResetPasswordForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        newUser = User(username = form.username.data, email = form.email.data, password = pw_hash)
